...
```
python3 continuous_pipeline.py --start-height "$(cat last_processed_block.txt)" --batch-size 100 --threads 8 --random-k-budget 2048 --hnp-timeout-sec 90 --hnp-min-leaks 12
```
